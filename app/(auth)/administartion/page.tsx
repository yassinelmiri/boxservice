...
import pg_auth from "@/public/assets/image/administartion.jpg";
...
const LoginPage: React.FC = () => {
  ...
  const handleLogin = async (e: FormEvent) => {
    ...
    try {
      ...
      // Ajouter le rôle 'admin' dans le cookie
      document.cookie = `token=${access_token}; path=/; max-age=${60 * 60 * 24 * 7}`;
      document.cookie = `role=admin; path=/; max-age=${60 * 60 * 24 * 7}`;
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="w-full max-w-md p-8 space-y-8 bg-white/30 backdrop-blur-sm rounded-lg shadow-2xl"
      >
